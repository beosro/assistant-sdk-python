...
import random
import sys
sys.path.insert(0,'/home/pi/rgbled')
...
class Face:
        ...
        def start(main):
                ...
                frontalface = cv2.CascadeClassifier("/home/pi/face/haarcascade_frontalface_alt2.xml")		# frontal face pattern detection
                profileface = cv2.CascadeClassifier("/home/pi/face/haarcascade_profileface.xml")		# side face pattern detection
                ...
                while True:
                        ...
                        if fe == 1:
                                ...
                                if fs == 0:
                                        ...
                                        file = open("/home/pi/speaking.txt","r")
                                        mode = int(file.read())
                                        file.close()
                                        if mode == 0:
                                                thread.start_new_thread(change,(main))
                                                thread.start_new_thread(speak,(m,))
